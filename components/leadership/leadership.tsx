    ...
    <section className="py-7 md:py-14">
        <div className="container">
            <div className="flex flex-col lg:flex-row justify-between gap-10 relative">
                <div className="absolute -left-10 md:-left-40 top-24 w-80 md:w-134.25 h-80 md:h-132.75 bg-cover bg-top bg-no-repeat"
                ...
                <div className="w-full lg:max-w-93 relative z-20">
                    ...
                    <div className="text-base sm:text-xl text-[#C1C1C1] font-normal sm:leading-7 space-y-4 sm:space-y-8 mb-5 sm:mb-10">
                        <p>Leadership at Beyond Code combines deep operational expertise with advanced AI and system engineering capabilities.</p>
                        <p>The team focuses on building structured intelligence systems aligned with real institutional environments.</p>
                    </div>
                    <Button 
                        text="Contact us"
